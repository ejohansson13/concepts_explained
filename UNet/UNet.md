...
As we can see, increasing our kernel to 5x5 has resulted in a decrease in the size of our output matrix, from 4x4 to 2x2. Considering more values at a time results in fewer operations needed to consider the entirety of our input matrix. 
