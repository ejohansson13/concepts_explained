...
The U-Net is recycling and repurposing relevant information learned from earlier in its training period. We're remembering to keep the ball high before shooting while focusing on our follow-through after shooting. We're remembering not just the specific techniques we've been practicing in learning to shoot a ball, but their broader context in the complete movement of shooting a ball. Augmenting the most important techniques with their positional context affirms 

We're remembering to turn our hips and shoulders towards the basket, while focusing on staying on our toes after catching the ball. We're augmenting the micro-techniques we've been focusing on with the broader context encapsulating the complete movement. Throughout the encoding path, the U-Net has learned the significant image features but might have lost sight of each feature's fit in the broader context.

Concatenation of the encoder-stage images mitigates this. The cropped encoder stage features contain spatial awareness of all the objects in the image. The decoder stage features have lost their spatial information when upsampling from smaller image dimensions. Combining the encoder and decoder stage representations allows us to reconcile both the significant image features and their structural proximity, greatly boosting our network's overall image perception. A simplified example is given below, taken from [this video](https://www.youtube.com/watch?v=NhdzGfB1q74) which does a great job explaining the overall U-net architecture.
